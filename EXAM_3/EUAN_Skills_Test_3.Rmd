...
# Creating the scatter plot with box plots
...
# Build an ANOVA model and display the summary output in my report
...
# Viewing the first few rows of the reshaped data
head(reshaped_data)
...
# Defining the list of chemical compounds
...
#QUESTION 4  Make me a graph of the following: don't change this part everything reads well 
# Load necessary library
library(ggplot2)
...
# Creating the generalized linear model
...
# View the significant chemicals and  model output
